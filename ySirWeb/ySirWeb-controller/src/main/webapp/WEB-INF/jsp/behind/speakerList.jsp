        ...
        <nav aria-label="..." class="navbar-right" style="margin-right: 15px">
            <ul class="pagination">
                ...
                <li <c:if test="${pageInfo.pageNum==1}">class="disabled"</c:if>>
                    <a href="${pageContext.request.contextPath}/speaker/showSpeakerList?pageNum=${pageInfo.pageNum-1}" aria-label="Previous"><span
                            aria-hidden="true">«</span></a></li>
                <c:forEach begin="1" end="${pageInfo.pages}" var="num">
                    <c:if test="${pageInfo.pageNum==num}"><li class="active"><a href="#">${num} <span class="sr-only">(current)</span></a></li></c:if>
                    <c:if test="${pageInfo.pageNum!=num}"><li><a href="${pageContext.request.contextPath}/speaker/showSpeakerList?pageNum=${num}">${num}</a></li></c:if>
                ...
                ><a href="${pageContext.request.contextPath}/speaker/showSpeakerList?pageNum=${pageInfo.pageNum+1}" aria-label="Next"><span aria-hidden="true">»</span></a></li>
            </ul>
        </nav>
    </div>
</div>
